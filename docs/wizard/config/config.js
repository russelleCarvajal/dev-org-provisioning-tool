export default {
    ...
    'wizardUriBase': 'https://russelleCarvajal.github.io/dev-org-provisioning-tool/wizard/',

    // The actual URL of the landing page of your web app.
    //'premiumAppURL': 'http://localhost:3000/',
    'premiumAppURL': 'https://russelleCarvajal.github.io/dev-org-provisioning-tool/',
